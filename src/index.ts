3; /*3- Escriba un programa que pida al usuario 
...
let entero1: number | null = Number(prompt("Ingrese el primer numero: "));
...
let entero2: number | null = Number(
  prompt("Ingrese el segundo numero numero: ")
);
valor = entero2;
